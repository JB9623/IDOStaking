...
use crate::{
    ...
    instruction::{
        ...
        UnstakeStartInput, DoStakeInput,
    },
    invoke::{self},
    math::{self, ErrorAdd},
    program::{
    ...
    pub fn process_instruction(
        ...
        match instruction {
            ...
            Instruction::DoStake(input) => {
                msg!("Instruction::DoStake");
                match accounts {
                    [pool, pool_authority, pool_token_account_sos, user_token_account_sos, user_token_account_xsos, user_wallet, pool_mint_xsos, token_program, ..] => {
                        Self::do_stake(
                            &program_id,
                            pool,
                            pool_authority,
